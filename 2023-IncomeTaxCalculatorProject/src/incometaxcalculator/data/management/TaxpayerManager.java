...
public class TaxpayerManager {
  ...
  public void createTaxpayer(String fullname, int taxRegistrationNumber, String status,
    ...
    TaxpayerCreator object = new TaxpayerCreator();
    object.createTaxpayer(fullname, taxRegistrationNumber, status, income);
    /* SIMPLIFY THIS CLASS
  ...
  private void updateFiles(int taxRegistrationNumber) throws IOException {
    FileUpdater object=new FileUpdater();
    object.updateFiles(taxRegistrationNumber);
    /* SIMPLIFY THIS CLASS
  ...
  public void saveLogFile(int taxRegistrationNumber, String fileFormat)
    ...
    LogFileSaver object=new LogFileSaver();
    object.saveLogFile(taxRegistrationNumber,fileFormat);
    /* SIMPLIFY THIS CLASS
  ...
  public void loadTaxpayer(String fileName)
    ...
    TaxpayerLoader object = new TaxpayerLoader();
    object.loadTaxpayer(fileName);
