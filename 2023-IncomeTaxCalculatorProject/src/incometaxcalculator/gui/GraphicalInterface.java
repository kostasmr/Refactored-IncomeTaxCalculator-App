...
public class GraphicalInterface extends JFrame{
  ...
  public GraphicalInterface() {
    ...
    //IMPROVEMENT TASK : click on the list to see taxpayer data
    taxRegisterNumberList.addMouseListener(new MouseListener()
    {
      @Override
    ...
    btnDeleteTaxpayer.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent arg0) {
        if (taxpayerManager.containsTaxpayer()) {
          DeleteTaxFrame deleteFrame = new DeleteTaxFrame(taxRegisterNumberList,taxpayerManager,taxRegisterNumberModel);
          deleteFrame.setVisible(true);
          /*IMPROVEMENT TASK: open another frame
          String trn = JOptionPane.showInputDialog(null,
